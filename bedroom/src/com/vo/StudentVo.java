...
public class StudentVo implements java.io.Serializable {
	...
	private String studentsInSchool;
	...
	public String getStudentsPinyin() {
		return studentsPinyin;
	}
	public void setStudentsPinyin(String studentsPinyin) {
		this.studentsPinyin = studentsPinyin;
	}
	public String getStudentsInRoomTime() {
		return studentsInRoomTime;
	}
	public void setStudentsInRoomTime(String studentsInRoomTime) {
	...
	public String getStudentsInSchool() {
		return studentsInSchool;
	}
	public void setStudentsInSchool(String studentsInSchool) {
