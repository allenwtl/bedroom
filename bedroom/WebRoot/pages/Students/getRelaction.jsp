...
<script type="text/javascript" src="js/getRelation.js" ></script>
	...
	<div id="myDiv"  style="width: 1000px;">
		<form id="myForm3" >
			<table  id="second"  border="1">
				<tr><td colspan="6"><font size="6">主要社会关系</font></td></tr>
				<tr>
					<td width="80px">称谓</td>
				...
				<tr id="row" class="CaseRow">
					<td width="80px"><input name="relationsVo.relationTitle" type="text" size="6"/></td>
					<td width="120px"><input name="relationsVo.relationName" type="text" size="10"/></td>
					<td width="150px">
						<select class="politics" name="relationsVo.relationPolitical" >
							<option >---请选择---</option>
						</select>
					</td>
					<td width="300px"><input name="relationsVo.relationUtil" type="text" size="30" /></td>
					<td width="120px" ><input name="relationsVo.relationPhone" type="text" size="11"/></td>
